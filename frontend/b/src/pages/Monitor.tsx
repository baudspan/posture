...
export const Monitor: React.FC = () => {
  ...
  // Sync relevant settings to the backend whenever they change
  useEffect(() => {
    if (connected) {
      sendSettings({
  ...
  }, [connected, settings.alert_cooldown_sec, settings.sound_alerts_enabled, settings.show_skeleton_overlay]);
